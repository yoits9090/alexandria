...
Endpoints: `GET /healthz`, `GET /readyz`, `GET /openapi.json`, `GET /v1/search?q=...`, `POST /v1/search`. Legacy aliases `/search` and `/api/search` accept the GET format contract (`json`, `text`, `html`).
