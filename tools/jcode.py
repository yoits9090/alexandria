...
def main():
    ...
    ap.add_argument("--format",choices=["json","toon"],default="json",help="stdout search representation")
    ap.add_argument("--prompt-format",choices=["json","toon"],default=None,help="representation sent to the LLM; defaults to TOON when the LLM is enabled")
